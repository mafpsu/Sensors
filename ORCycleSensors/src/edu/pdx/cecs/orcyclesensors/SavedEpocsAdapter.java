...
public class SavedEpocsAdapter extends BaseAdapter {

	private final static String MODULE_TAG = "SavedEpocsAdapter";
	...
	private final ArrayList<EpocDeviceInfo> epocDeviceList;
	private final int defaultColor;
	private final int selectedColor;
	private final ArrayList<Long> selectedItems = new ArrayList<Long>();

	public SavedEpocsAdapter(LayoutInflater layoutInflater, ArrayList<EpocDeviceInfo> EpocDeviceInfos,
			int defaultColor, int selectedColor) {

		this.layoutInflater = layoutInflater;
		this.defaultColor = defaultColor;
		this.selectedColor = selectedColor;
		this.epocDeviceList = EpocDeviceInfos;
	}
	...
	@Override
	public int getCount() {
		return epocDeviceList.size();
	}

	@Override
	public EpocDeviceInfo getItem(int position) {
		return epocDeviceList.get(position);
	}
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		try {
			// get current item 
			EpocDeviceInfo item = epocDeviceList.get(position);
